<div class="bg-noway-dark-darker m-12 flex flex-col gap-2">
	...
	<h3>Vercel</h3>
	<p>
		Diese Webseite nutzt den Dienst <a href="https://vercel.com/">Vercel</a>. Der Anbieter ist
		Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA. Vercel ist eine Cloudplattform, über
		die wir unsere Webseite bereitstellen. Das bedeutet, dass der Besuch unser Webseite durch die
		Server von Vercel bearbeitet oder durchgeleitet wird. Die mit deinem Besuch unserer Webseite
		verbundenen Daten werden auch an Vercel übermittelt. Dies ist notwendig, damit Deine
	...
	<p>
		Diese Daten werden je nach Serverstandort auch in die USA übertragen. Wir haben mit Vercel einen
		Vertrag über die Auftragsverarbeitung abgeschlossen. Außerdem ist Vercel unter dem <a
			href="https://www.privacyshield.gov/participant?id=a2zt0000000TTIbAAO&amp;status=Active"
			>EU-US Datenschutzabkommen zertifiziert</a
		> und damit verpflichtet, den EU-Datenschutzvorgaben nachzukommen.
	</p>
	<p>
		Die Datenschutzerklärung von Vercel findest Du unter <a
